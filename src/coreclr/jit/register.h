...
REGDEF(XMM0, XMMNUM(0), XMMMASK(0), "mm0")
REGDEF(XMM1, XMMNUM(1), XMMMASK(1), "mm1")
REGDEF(XMM2, XMMNUM(2), XMMMASK(2), "mm2")
REGDEF(XMM3, XMMNUM(3), XMMMASK(3), "mm3")
REGDEF(XMM4, XMMNUM(4), XMMMASK(4), "mm4")
REGDEF(XMM5, XMMNUM(5), XMMMASK(5), "mm5")
REGDEF(XMM6, XMMNUM(6), XMMMASK(6), "mm6")
REGDEF(XMM7, XMMNUM(7), XMMMASK(7), "mm7")

#ifdef TARGET_AMD64
REGDEF(XMM8,  XMMNUM(8),  XMMMASK(8),  "mm8")
REGDEF(XMM9,  XMMNUM(9),  XMMMASK(9),  "mm9")
REGDEF(XMM10, XMMNUM(10), XMMMASK(10), "mm10")
REGDEF(XMM11, XMMNUM(11), XMMMASK(11), "mm11")
REGDEF(XMM12, XMMNUM(12), XMMMASK(12), "mm12")
REGDEF(XMM13, XMMNUM(13), XMMMASK(13), "mm13")
REGDEF(XMM14, XMMNUM(14), XMMMASK(14), "mm14")
REGDEF(XMM15, XMMNUM(15), XMMMASK(15), "mm15")
#endif // TARGET_AMD64
