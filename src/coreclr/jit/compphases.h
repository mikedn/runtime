...
CompPhaseNameMacro(PHASE_SET_EVAL_ORDER,         "Set eval order",                 "EVAL-ORD", false, -1, true)
...
#endif
CompPhaseNameMacro(PHASE_DESTROY_SSA,            "Destroy SSA representation",     "SSA-OUT",  false, -1, false)
...
CompPhaseNameMacro(PHASE_LIR_LIVENESS,           "LIR local var liveness",         "LIR-LIV",  false, -1, false)
