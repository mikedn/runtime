...
GenTree* Importer::ImportBaseIntrinsic(NamedIntrinsic intrinsic, const HWIntrinsicSignature& sig)
{
    ...
    switch (intrinsic)
    {
        ...
        case NI_Vector256_get_AllBitsSet:
            ...
            if ((sig.retType == TYP_SIMD16) && !comp->compExactlyDependsOn(InstructionSet_SSE))
            {
                return nullptr;
            }
        ...
        case NI_Vector256_Create:
            ...
            if ((sig.retType == TYP_SIMD16) &&
                !comp->compExactlyDependsOn(eltType == TYP_FLOAT ? InstructionSet_SSE : InstructionSet_SSE2))
            {
                return nullptr;
            }
        ...
        case NI_Vector128_GetElement:
            ...
            if ((sig.paramType[0] == TYP_SIMD16) &&
                !comp->compExactlyDependsOn(sig.retType == TYP_FLOAT ? InstructionSet_SSE : InstructionSet_SSE2))
            {
                return nullptr;
            }
        ...
        case NI_Vector256_ToScalar:
            ...
            else
            {
                ...
                if (!comp->compExactlyDependsOn(sig.retType == TYP_FLOAT ? InstructionSet_SSE : InstructionSet_SSE2))
                {
                    return nullptr;
                }
            }
