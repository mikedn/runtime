...
void emitIns_Mov(
    instruction ins, emitAttr attr, RegNum dstReg, RegNum srgReg, bool canSkip, insFlags flags = INS_FLAGS_DONT_CARE);
...
void emitIns_R_R_I_I(
    instruction ins, emitAttr attr, RegNum reg1, RegNum reg2, int imm1, int imm2, insFlags flags = INS_FLAGS_DONT_CARE);
