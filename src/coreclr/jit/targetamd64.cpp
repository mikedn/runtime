...
const RegNum    intArgRegs[]{REG_EDI, REG_ESI, REG_EDX, REG_ECX, REG_R8, REG_R9};
const regMaskTP intArgMasks[]{RBM_EDI, RBM_ESI, RBM_EDX, RBM_ECX, RBM_R8, RBM_R9};

const RegNum    fltArgRegs[]{REG_XMM0, REG_XMM1, REG_XMM2, REG_XMM3, REG_XMM4, REG_XMM5, REG_XMM6, REG_XMM7};
const regMaskTP fltArgMasks[]{RBM_XMM0, RBM_XMM1, RBM_XMM2, RBM_XMM3, RBM_XMM4, RBM_XMM5, RBM_XMM6, RBM_XMM7};
#else
const RegNum    intArgRegs[]{REG_ECX, REG_EDX, REG_R8, REG_R9};
const regMaskTP intArgMasks[]{RBM_ECX, RBM_EDX, RBM_R8, RBM_R9};

const RegNum    fltArgRegs[]{REG_XMM0, REG_XMM1, REG_XMM2, REG_XMM3};
