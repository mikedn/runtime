...
GTSTRUCT_2(LclFld      , GT_LCL_FLD, GT_STORE_LCL_FLD)
GTSTRUCT_1(LclAddr     , GT_LCL_ADDR)
GTSTRUCT_1(SsaDef      , GT_SSA_DEF)
GTSTRUCT_1(SsaUse      , GT_SSA_USE)
GTSTRUCT_1(SsaPhi      , GT_SSA_PHI)
...
GTSTRUCT_N(Blk         , GT_BLK, GT_STORE_BLK, GT_OBJ, GT_STORE_OBJ)
